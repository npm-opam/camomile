...
# 123 "internal/uReStrParser.mly"
             (_1)
# 323 "internal/uReStrParser.ml"
               : UReStrParserType.tree))
; (fun __caml_parser_env ->
    Obj.repr(
# 124 "internal/uReStrParser.mly"
      (`Epsilon)
# 329 "internal/uReStrParser.ml"
               : UReStrParserType.tree))
; (fun __caml_parser_env ->
...
# 128 "internal/uReStrParser.mly"
      (`Set any)
# 342 "internal/uReStrParser.ml"
               : 'regexp))
; (fun __caml_parser_env ->
    Obj.repr(
# 129 "internal/uReStrParser.mly"
      (bol)
# 348 "internal/uReStrParser.ml"
               : 'regexp))
; (fun __caml_parser_env ->
    Obj.repr(
# 130 "internal/uReStrParser.mly"
         (eol)
# 354 "internal/uReStrParser.ml"
               : 'regexp))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'regexp) in
    Obj.repr(
...
# 139 "internal/uReStrParser.mly"
      (`BoS)
# 419 "internal/uReStrParser.ml"
               : 'regexp))
; (fun __caml_parser_env ->
    Obj.repr(
# 140 "internal/uReStrParser.mly"
      (`EoS)
# 425 "internal/uReStrParser.ml"
               : 'regexp))
; (fun __caml_parser_env ->
...
# 145 "internal/uReStrParser.mly"
        (UChar.of_char '-')
# 445 "internal/uReStrParser.ml"
               : 'uchar))
; (fun __caml_parser_env ->
    Obj.repr(
# 146 "internal/uReStrParser.mly"
             (UChar.of_char '{')
# 451 "internal/uReStrParser.ml"
               : 'uchar))
; (fun __caml_parser_env ->
    Obj.repr(
# 147 "internal/uReStrParser.mly"
              (UChar.of_char '}')
# 457 "internal/uReStrParser.ml"
               : 'uchar))
; (fun __caml_parser_env ->
    Obj.repr(
# 148 "internal/uReStrParser.mly"
        (UChar.of_char ' ')
# 463 "internal/uReStrParser.ml"
               : 'uchar))
; (fun __caml_parser_env ->
    Obj.repr(
# 149 "internal/uReStrParser.mly"
      (UChar.of_char '&')
# 469 "internal/uReStrParser.ml"
               : 'uchar))
; (fun __caml_parser_env ->
    Obj.repr(
# 150 "internal/uReStrParser.mly"
     (UChar.of_char '|')
# 475 "internal/uReStrParser.ml"
               : 'uchar))
; (fun __caml_parser_env ->
    Obj.repr(
# 151 "internal/uReStrParser.mly"
        (UChar.of_char ':')
# 481 "internal/uReStrParser.ml"
               : 'uchar))
; (fun __caml_parser_env ->
...
; (fun __caml_parser_env ->
    ...
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'tail_charset) in
    Obj.repr(
# 157 "internal/uReStrParser.mly"
                                    (`Union (_1, _2))
# 511 "internal/uReStrParser.ml"
               : 'charset))
; (fun __caml_parser_env ->
...
; (fun __caml_parser_env ->
    ...
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'tail_charset) in
    Obj.repr(
# 165 "internal/uReStrParser.mly"
                                         (`Union (_1, _2))
# 548 "internal/uReStrParser.ml"
               : 'tail_charset))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'unquote) in
    Obj.repr(
# 166 "internal/uReStrParser.mly"
          (`Set _1)
# 555 "internal/uReStrParser.ml"
               : 'tail_charset))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'set) in
    Obj.repr(
# 167 "internal/uReStrParser.mly"
      (_1)
...
# 170 "internal/uReStrParser.mly"
             (quoted_charset '(')
# 568 "internal/uReStrParser.ml"
               : 'unquote))
; (fun __caml_parser_env ->
    Obj.repr(
# 171 "internal/uReStrParser.mly"
              (quoted_charset ')')
# 574 "internal/uReStrParser.ml"
               : 'unquote))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : int * (int option) * string) in
    Obj.repr(
# 172 "internal/uReStrParser.mly"
       (let _, _, s = _1 in set_of_string s)
# 581 "internal/uReStrParser.ml"
               : 'unquote))
; (fun __caml_parser_env ->
    Obj.repr(
# 173 "internal/uReStrParser.mly"
      (quoted_charset '`')
# 587 "internal/uReStrParser.ml"
               : 'unquote))
; (fun __caml_parser_env ->
    Obj.repr(
# 174 "internal/uReStrParser.mly"
      (quoted_charset '\'')
# 593 "internal/uReStrParser.ml"
               : 'unquote))
; (fun __caml_parser_env ->
    Obj.repr(
# 175 "internal/uReStrParser.mly"
      (quoted_charset '|')
# 599 "internal/uReStrParser.ml"
               : 'unquote))
; (fun __caml_parser_env ->
...
# 178 "internal/uReStrParser.mly"
                                      (_2)
# 606 "internal/uReStrParser.ml"
               : 'set))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : UChar.t) in
    Obj.repr(
# 181 "internal/uReStrParser.mly"
        (_1)
# 613 "internal/uReStrParser.ml"
               : 'common_charset_char))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : char) in
    Obj.repr(
# 182 "internal/uReStrParser.mly"
        (UChar.of_char _1)
# 620 "internal/uReStrParser.ml"
               : 'common_charset_char))
; (fun __caml_parser_env ->
    Obj.repr(
# 183 "internal/uReStrParser.mly"
           (UChar.of_char '*')
# 626 "internal/uReStrParser.ml"
               : 'common_charset_char))
; (fun __caml_parser_env ->
    Obj.repr(
# 184 "internal/uReStrParser.mly"
       (UChar.of_char '+')
# 632 "internal/uReStrParser.ml"
               : 'common_charset_char))
; (fun __caml_parser_env ->
    Obj.repr(
# 185 "internal/uReStrParser.mly"
           (UChar.of_char '?')
# 638 "internal/uReStrParser.ml"
               : 'common_charset_char))
; (fun __caml_parser_env ->
    Obj.repr(
# 186 "internal/uReStrParser.mly"
      (UChar.of_char '.')
# 644 "internal/uReStrParser.ml"
               : 'common_charset_char))
; (fun __caml_parser_env ->
    Obj.repr(
# 187 "internal/uReStrParser.mly"
         (UChar.of_char '$')
# 650 "internal/uReStrParser.ml"
               : 'common_charset_char))
; (fun __caml_parser_env ->
    Obj.repr(
# 188 "internal/uReStrParser.mly"
               (UChar.of_char '[')
# 656 "internal/uReStrParser.ml"
               : 'common_charset_char))
; (fun __caml_parser_env ->
    Obj.repr(
# 189 "internal/uReStrParser.mly"
        (UChar.of_char ' ')
# 662 "internal/uReStrParser.ml"
               : 'common_charset_char))
; (fun __caml_parser_env ->
    Obj.repr(
# 190 "internal/uReStrParser.mly"
      (UChar.of_char '&')
# 668 "internal/uReStrParser.ml"
               : 'common_charset_char))
; (fun __caml_parser_env ->
    Obj.repr(
# 191 "internal/uReStrParser.mly"
     (UChar.of_char '|')
# 674 "internal/uReStrParser.ml"
               : 'common_charset_char))
; (fun __caml_parser_env ->
    Obj.repr(
# 192 "internal/uReStrParser.mly"
        (UChar.of_char ':')
# 680 "internal/uReStrParser.ml"
               : 'common_charset_char))
; (fun __caml_parser_env ->
    Obj.repr(
# 193 "internal/uReStrParser.mly"
        (UChar.of_char '-')
# 686 "internal/uReStrParser.ml"
               : 'common_charset_char))
; (fun __caml_parser_env ->
    Obj.repr(
# 196 "internal/uReStrParser.mly"
                (UChar.of_char ']')
# 692 "internal/uReStrParser.ml"
               : 'head_charset_char))
; (fun __caml_parser_env ->
...
# 197 "internal/uReStrParser.mly"
                      (_1)
# 699 "internal/uReStrParser.ml"
               : 'head_charset_char))
; (fun __caml_parser_env ->
    Obj.repr(
# 200 "internal/uReStrParser.mly"
      (UChar.of_char '^')
# 705 "internal/uReStrParser.ml"
               : 'charset_char))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'common_charset_char) in
    Obj.repr(
...
; (fun __caml_parser_env ->
    ...
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'set_notation) in
    Obj.repr(
# 208 "internal/uReStrParser.mly"
                                (`Intr (_1, _3))
# 742 "internal/uReStrParser.ml"
               : 'set_notation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'set_notation) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'set_notation) in
